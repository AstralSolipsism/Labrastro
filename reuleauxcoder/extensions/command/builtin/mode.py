    ...
    registry.register_many(
        [
            ActionSpec(
                ...
                triggers=(slash_trigger("/mode", available_during_run=True),),
            ...
            ActionSpec(
                ...
                required_capabilities=TEXT_REQUIRED,
                triggers=(
                    slash_trigger("/mode current", available_during_run=True),
                    slash_trigger("/mode now", available_during_run=True),
                ),
