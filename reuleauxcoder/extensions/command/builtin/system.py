    ...
    registry.register_many(
        [
            ActionSpec(
                ...
                triggers=(slash_trigger("/help", available_during_run=True),),
                parser=_parse_help,
            ...
            ActionSpec(
                ...
                ui_targets=UI_TARGETS,
                required_capabilities=TEXT_REQUIRED,
                triggers=(slash_trigger("/quit"), slash_trigger("/exit")),
                parser=_parse_exit,
            ...
            ActionSpec(
                ...
                triggers=(
                    slash_trigger(
                        "/compact",
                        supports_args=True,
                        args_hint="force <snip|summarize|collapse>",
                    ),
                ),
            ...
            ActionSpec(
                ...
                ui_targets=UI_TARGETS,
                required_capabilities=TEXT_REQUIRED,
                triggers=(slash_trigger("/tokens", available_during_run=True),),
