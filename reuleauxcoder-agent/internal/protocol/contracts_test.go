...
func TestRemoteContractFixturesDecodePeerProtocolSamples(t *testing.T) {
	...
	mustDecode(t, fixtures["chat.stream"].Request, &ChatStreamRequest{})
	mustDecode(t, fixtures["chat.stream"].Response, &ChatStreamResponse{})
	mustDecode(t, fixtures["runtime.claim"].Request, &AgentRuntimeClaimRequest{})
	mustDecode(t, fixtures["runtime.claim"].Response, &AgentRuntimeClaimResponse{})
	mustDecode(t, fixtures["runtime.events"].Response, &AgentRuntimeEventsResponse{})
	mustDecode(t, fixtures["runtime.complete"].Request, &AgentRuntimeCompleteRequest{})
	mustDecode(t, fixtures["runtime.complete"].Response, &AgentRuntimeCompleteResponse{})
